...
def run_bin2csv(bin_file, csv_file):  # 建立一个任务线程类:  # 在启动线程后任务从这个函数里面开始执行
    tempTimesStamp = 0
...
#bin2csv('C:/Users/usuario/Desktop/MATA00-1004258-20240118-171307.BIN', 'C:/Users/usuario/Desktop/30min.csv')